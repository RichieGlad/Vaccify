...
class CustomStateSpinnerAdapter(
    val context: Context,
    private var stateListResModel: List<StateListResModel>
) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = stateListResModel[position].state_name
    ...
    override fun getItem(position: Int): Any {
        return stateListResModel[position];
    }

    override fun getCount(): Int {
        return stateListResModel.size;
    }
